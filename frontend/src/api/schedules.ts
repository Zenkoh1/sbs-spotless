...
export function retrieveAllSchedules(): Promise<Schedule[]> {
  return axios
    .get(`${BACKEND_URL}cleaning_schedules`, {
      headers: {
...
export function retrieveScheduleById(scheduleId: number): Promise<Schedule> {
  return axios
    .get(`${BACKEND_URL}cleaning_schedules/${scheduleId}`, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem("access_token")}`,
      },
    })
...
export function retrieveAllChecklistStepsByScheduleId(
  scheduleId: number
): Promise<Step[]> {
  return axios
    .get(`${BACKEND_URL}cleaning_schedules/${scheduleId}/checklist_steps`, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem("access_token")}`,
      },
    })
...
export function createSingleSchedule(
  ...
  return axios
    .post(`${BACKEND_URL}cleaning_schedules/`, schedule, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem("access_token")}`,
      },
    })
...
export function createMassSchedule(
